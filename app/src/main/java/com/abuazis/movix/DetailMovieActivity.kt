...
//        mDatabase = FirebaseDatabase.getInstance().getReference("Film").child(data.judul.toString()).child("play")
        ...
        btn_pilih_bangku.setOnClickListener {
            val intent = Intent(this@DetailMovieActivity, ChoseSeatActivity::class.java).putExtra("data", data)
            startActivity(intent)
        }
        ...
        rv_whoplay.layoutManager = LinearLayoutManager(this@DetailMovieActivity, LinearLayoutManager.HORIZONTAL, false)
        getData()
    }
