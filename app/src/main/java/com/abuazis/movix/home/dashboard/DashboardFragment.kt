package com.abuazis.movix.home.dashboard
...
import com.abuazis.movix.DetailMovieActivity
import com.abuazis.movix.DetailMovieComingActivity
...
import com.abuazis.movix.home.model.Film
        ...
        mDatabase.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                rv_now_playing.adapter = NowPlayingAdapter(dataList) {
                    val intent = Intent(context, DetailMovieActivity::class.java).putExtra("data", it)
